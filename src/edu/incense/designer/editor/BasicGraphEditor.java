...
/**
 * Contains the layout of the whole Editor.
 * @author mxpxgx
 *
 */
...
public class BasicGraphEditor extends JPanel {
    ...
    static {
        try {
            mxResources.add("edu/incense/designer/resources/editor");
        } catch (Exception e) {
            System.err.println("BasicGraphEditor: Loading resources: "+e);
        }
    }
...
//                - libraryScrollPane.getVerticalScrollBar().getWidth();
     ...
     *            to create the layout instance for the commercial graph edu.incense.designer.editor
     *            example.
